"""
Django settings for major_motors project.
...
ROOT_URLCONF = 'major_motors.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'crm.context_processors.cash_account',
                'crm.context_processors.site_theme',
            ],
        },
    },
]

WSGI_APPLICATION = 'major_motors.wsgi.application'
